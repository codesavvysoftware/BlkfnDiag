////////////////////////////////////////////////////////////////////////////////
/// @file ApexDiagnostic.hpp
///
/// @details ApexDiagnostic class definition.
///
...
////////////////////////////////////////////////////////////////////////////////
#ifndef APEXDIAGNOSTIC_HPP
#define APEXDIAGNOSTIC_HPP
...
public:
    ...
    /// Converts ms to timeslices.
    inline static UINT32 MsToDgnSlices(UINT32 value);
    ...
    {
        DGN_MCRC_LOOPBACK_NUM,       // mCRC loopback test
        DGN_BP_LOOPBACK_NUM,         // Backplane loopback test
        DGN_RAM_ADDR_NUM,            // RAM address test
        ...
        DGN_ARM_NUM,                 // ARM instructions and registers
        DGN_ARM_CACHE_NUM,           // ARM data cache
        DGN_ECC_NUM,                 // ECC test
    ...
    static const UINT32 SLICE_TIME_LIMIT_US = 10;           // Max allowed time (us)
...
private:
    ...
    ApexDiagnostic(const ApexDiagnostic &);
    ApexDiagnostic &operator=(const ApexDiagnostic &);
...
/////////////////////////////////////////////////////////////////////////////
inline UINT32 ApexDiagnostic::MsToDgnSlices(UINT32 value)
{
...
#endif // #if !defined(APEXDIAGNOSTIC_HPP)
