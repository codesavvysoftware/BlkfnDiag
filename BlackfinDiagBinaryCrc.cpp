////////////////////////////////////////////////////////////////////////////////
/// @file BlackfinDiagBinaryCrc.cpp
///
...
// C++ PROJECT INCLUDES
#include "BlackfinDiagBinaryCrc.h"            // BlackfinDiagBinaryCrc class declaration
...
UINT32 BlackfinDiagBinaryCrc::m_CodeSize;
UINT32 BlackfinDiagBinaryCrc::m_CrcExpected;
UINT32 BlackfinDiagBinaryCrc::m_BytesPerStep;
UINT32 BlackfinDiagBinaryCrc::m_Crc;
UINT32 BlackfinDiagBinaryCrc::m_BytesLeft;
const UINT8 *BlackfinDiagBinaryCrc::m_pCurrentPtr;
...
////////////////////////////////////////////////////////////////////////////////
//  METHOD NAME: BlackfinDiagBinaryCrc::CrcDataReset
//
/// @memberof BlackfinDiagBinaryCrc
///
/// @details Resets CRC data to initial values.
/////////////////////////////////////////////////////////////////////////////
void BlackfinDiagBinaryCrc::CrcDataReset(void)
{
    m_Crc          = 0xffffffff;
...
////////////////////////////////////////////////////////////////////////////////
//  METHOD NAME: BlackfinDiagBinaryCrc::Init
//
/// @memberof BlackfinDiagBinaryCrc
///
/// @details Initializes CRC data diagnostic.
/////////////////////////////////////////////////////////////////////////////
void BlackfinDiagBinaryCrc::Init(void)
{
    return;
...
////////////////////////////////////////////////////////////////////////////////
// BlackfinDiagBinaryCrc::CalculateCrc32
//
...
///
////////////////////////////////////////////////////////////////////////////////
UINT32 BlackfinDiagBinaryCrc::CalculateCrc32(const UINT8 *&pData, const UINT32 byteLen, UINT32 crc)
{
...
////////////////////////////////////////////////////////////////////////////////
// BlackfinDiagBinaryCrc::PowerupTest
///
/// @memberof BlackfinDiagBinaryCrc
///
...
///          at powerup.
/////////////////////////////////////////////////////////////////////////////
void BlackfinDiagBinaryCrc::PowerupTest(void)
{
    return;
...
/*    const UINT8* codeSpaceStart = (UINT8*)DGN_CODE_SPACE_START;
    ...
    UINT32 startTimeUs = GetSystemTime(); //HI_ApexReg.SystemTime;
    crc = CalculateCrc32(codeSpaceStart, m_CodeSize, crc);
    UINT32 crcCountTimeUs = GetSystemTime() - startTimeUs; //HI_ApexReg.SystemTime - startTimeUs;
    ...
    startTimeUs = GetSystemTime(); //HI_ApexReg.SystemTime
    (void)RunTest(NULL);
    UINT32 crcOverheadUs = GetSystemTime() - startTimeUs; //HI_ApexReg.SystemTime - startTimeUs;

    // calculate bytes for timeslice
    UINT32 bytesPerStep = 0;
    if (crcOverheadUs < BlackfinDiagnostic::SLICE_TIME_LIMIT_US)
    {
        UINT32 timeForCalculationUs = (BlackfinDiagnostic::SLICE_TIME_LIMIT_US - crcOverheadUs);
    ...
    UINT32 activeTimeslicesBeforeTimeout = 
                    BlackfinDiagnostic::DgnList[BlackfinDiagnostic::DGN_EXE_CRC_NUM].timeoutTimeslice 
                    / BlackfinDiagnostic::DgnList[BlackfinDiagnostic::DGN_EXE_CRC_NUM].stepValueTimeslice;
...
/////////////////////////////////////////////////////////////////////////////
TestState BlackfinDiagBinaryCrc::RunTest(DiagControlBlock *)
{
