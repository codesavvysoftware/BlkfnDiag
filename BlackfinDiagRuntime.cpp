...
DiagTime_t defaultCurrentExecutionTimeMS     = 0;
DiagTime_t defaultMaxTestDurationTimeMS      = 0;
DiagTime_t defaultMaxTimeForTestCompletionMS = 4 * 60 * 60 * 1000;  // 4 hours
DiagTime_t defaultTestStartTime              = 0;
...
DiagTime_t       dataRAMTestIterationPeriodMS_            = 1000; // 1 second for now
DiagTime_t       dataRAMStartOffsetFromDiagCycleStartMS_  = 20;   // Start 20 ms after the diagnostic cycle starts
...
DiagTime_t                registerTestIterationPeriodMS_ = 2000;          // Every Two Seconds	
DiagTime_t                registerTestStartOffsetFromDiagCycleStartMS_;  // Start 250 ms in
...
//                                                                                                          *
//***********************************************************************************************************
DiagTime_t       instructionRamTestIterationPeriodMS_            = 2000; // 2 second for now
DiagTime_t       instructionRAMStartOffsetFromDiagCycleStartMS_  = 500;   // Start 500 ms after the diagnostic cycle starts
